...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Call Us",
      details: [
        "Fixe & WhatsApp: +212 6 18 38 23 85",
        "Customer Service: +212 5 00 00 00 00",
      ],
    ...
    },
    {
      ...
      title: "Email Us",
      details: [
        "General Inquiries: info@3otor.com",
        "Support: support@3otor.com",
      ],
  ...
  const faqs = [
    {
      ...
      answer:
        "We offer a 30-day return policy for unopened and unused products with original packaging.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, all 3OTOR products are cruelty-free and never tested on animals.",
    },
  ];
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-amber-100 mb-8 leading-relaxed">
              We're here to help you find your perfect scent. Contact us for
              personalized fragrance consultations and exceptional customer
              service.
            </p>
                ...
                {isSubmitted ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-6">
                      Thank you for contacting 3OTOR. Our team will get back to
                      you within 24 hours.
                    </p>
                    <button
                      type="button"
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600">
              Experience our luxury fragrances in person at our Meknes flagship
              location
            </p>
          </div>
                ...
                <div className="h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-gray-600 mb-4">
                      Find directions to our flagship store
                    </p>
